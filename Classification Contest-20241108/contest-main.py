...
def score_model(clf_model, student_name):
    ...
    print("Remember to send both files to tommaso.zoppi@unifi.it, mail tag [DCML24] Context <Bollecchino Matteo- Monicolini Matteo>")


if __name__ == "__main__":
    # General vars
    STUDENT_NAME = 'Bollecchino Matteo - Monicolini Matteo'
    MY_CLF = None
